---
title: "Customizing Embed Colors in Discord Ticket Bot"
...
- **Select menu response** — The ephemeral dropdown prompt shown when a user clicks the Create Ticket button.
