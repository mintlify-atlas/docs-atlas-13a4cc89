...
<CardGroup cols={2}>
  <Card title="Interactive Ticket Creation" icon="ticket" href="/usage/ticket-workflow">
    Members click a single button to open a ticket — no commands to remember.
  </Card>
  <Card title="Ticket Categories" icon="list" href="/usage/ticket-workflow">
    Select menus let users choose Question, Help, or Report before a channel is created.
  </Card>
  <Card title="Scoped Channel Permissions" icon="lock" href="/reference/permissions">
    Each ticket channel is visible only to the ticket creator and your staff role.
  </Card>
  <Card title="Staff Notifications" icon="bell" href="/usage/ticket-commands">
    A built-in Call Staff button pings your staff role directly inside the ticket channel.
  </Card>
  <Card title="Confirmed Close Flow" icon="circle-check" href="/usage/ticket-commands">
    Closing a ticket requires confirmation, preventing accidental deletions.
  </Card>
  <Card title="Ticket Logs" icon="clipboard-list" href="/reference/events">
