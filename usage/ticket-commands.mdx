---
title: "Ticket Bot Commands and Button Interactions"
sidebarTitle: "Commands"
description: "Full reference for the tb!ticket command and every button and select menu interaction the Discord Ticket Bot handles."
---
...
After the channel is created the bot sends an ephemeral-style response (auto-deleted after 3 seconds) to the member confirming the channel was created, then posts a welcome embed inside the new channel. Every ticket channel gets the same two action buttons: **🔐 Close ticket** (red) and **🔔 Call staff** (blue).
